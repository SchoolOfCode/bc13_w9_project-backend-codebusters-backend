...
export async function populateTweetsTable() {
  const objects = [
    ...
    { title: 'For loops', definition: 'Loops can execute a block of code a number of times.', example: 'https://cdn.programiz.com/sites/tutorial2program/files/working-javascript-continue-statement.pnG', links: 'https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Statements/for', week: 1},
